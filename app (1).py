...
GMAPS_KEY = os.environ.get("GMAPS_KEY", "AIzaSyBxYGy6yctbxXPvzI553ANEQgoswVbP1dQ")
...
<div class="wrap">
  ...
  <!-- GDPR SCREEN -->
  <div class="sc on" id="s-1">
    <div class="ch">
      <h1>ROTONDI<br><em>GROUP ROMA</em></h1>
      <p id="t-sub-gdpr">Informativa Privacy prima di procedere</p>
    </div>
    <div style="background:rgba(88,166,255,.08);border:1px solid rgba(88,166,255,.25);border-radius:8px;padding:6px 14px;display:inline-flex;align-items:center;gap:6px;font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:#58a6ff;margin-bottom:16px">
      🔒 <span id="t-gdpr-badge">Privacy &amp; GDPR</span>
    </div>
    <div style="background:var(--card);border:1px solid var(--border);border-radius:12px;padding:20px;margin-bottom:14px;max-height:220px;overflow-y:auto;font-size:13px;line-height:1.75;color:var(--muted)">
      <h4 style="color:var(--text);margin-bottom:10px;font-weight:600" id="t-gdpr-h">Informativa sul trattamento dei dati personali</h4>
      <p id="t-gdpr-1" style="margin-bottom:10px"></p>
      <p id="t-gdpr-2" style="margin-bottom:10px"></p>
      <p id="t-gdpr-3" style="margin-bottom:10px"></p>
      <p id="t-gdpr-4" style="margin-bottom:10px"></p>
      <p id="t-gdpr-5" style="margin-bottom:0"></p>
    </div>
    <label style="display:flex;align-items:flex-start;gap:12px;padding:14px;background:rgba(201,168,76,.05);border:1px solid rgba(201,168,76,.2);border-radius:8px;margin-bottom:10px;cursor:pointer">
      <input type="checkbox" id="chk1" onchange="chkGdpr()" style="width:18px;height:18px;flex-shrink:0;margin-top:1px;accent-color:var(--gold);cursor:pointer">
      <span id="t-chk1" style="font-size:13px;line-height:1.5;color:var(--text)"></span>
    </label>
    <label style="display:flex;align-items:flex-start;gap:12px;padding:14px;background:rgba(201,168,76,.05);border:1px solid rgba(201,168,76,.2);border-radius:8px;margin-bottom:16px;cursor:pointer">
      <input type="checkbox" id="chk2" onchange="chkGdpr()" style="width:18px;height:18px;flex-shrink:0;margin-top:1px;accent-color:var(--gold);cursor:pointer">
      <span id="t-chk2" style="font-size:13px;line-height:1.5;color:var(--text)"></span>
    </label>
    <button class="bnext" id="btn-gdpr" onclick="go(0)" disabled id="t-gdpr-btn">Continua</button>
  </div>
...
<script>
var lang='it',cur=-1,prevTimer=null,prevData=null;

var TX={
  it:{
    'gdpr-badge':'Privacy e GDPR',
    'gdpr-h':'Informativa sul trattamento dei dati personali',
    'gdpr-1':"Ai sensi degli artt. 13-14 del Reg. UE 2016/679 (GDPR), i Suoi dati personali (nome, indirizzo, telefono, e-mail, foto) saranno trattati da <b>Rotondi Group Srl</b>, Via F.lli Rosselli 14/16, 20019 Settimo Milanese (MI), quale Titolare del trattamento.",
    'gdpr-2':'<b>Finalita:</b> Gestione della richiesta di assistenza tecnica e contatto con il tecnico assegnato.',
    'gdpr-3':'<b>Base giuridica:</b> Esecuzione di un contratto (art. 6(1)(b) GDPR).',
    'gdpr-4':'<b>Conservazione:</b> Non oltre 2 anni dalla chiusura della pratica.',
    'gdpr-5':'<b>Diritti:</b> Accesso, rettifica, cancellazione, opposizione, portabilita. Contatto: <u>segnalazioni-privacy@rotondigroup.it</u>',
    'chk1':"Ho letto l'informativa e <b>acconsento</b> al trattamento dei miei dati personali.",
    'chk2':'Confermo di aver letto le <b>condizioni di servizio</b> e le <b>tariffe</b>.',
    'sub-gdpr':'Rotondi Group Roma - Informativa Privacy',
    'gdpr-btn':'Continua',
    title:'ASSISTENZA<br><em>TECNICA</em>',sub:'Rotondi Group Roma - Leggi le condizioni prima di procedere',ctitle:'Informativa sul servizio',z1:'TARIFFE ZONA DI ROMA (dentro il Grande Raccordo Anulare)',z2:"TARIFFE PROVINCIA DI ROMA, LAZIO E RESTO D'ITALIA",r1l:'Uscita + 1 ora lavoro',r2l:'Ore successive',r3l:'Trasferta km',r4l:'Ore viaggio',r5l:'Ore lavoro',acc:'Accetto le condizioni',dec:'Rifiuto',bk:'Indietro',f1h:'Dati personali',f1p:'Inserisci i tuoi dati di contatto',f1s:'Passo 1 di 3',ln:'Nome e cognome *',li:'Indirizzo completo *',lt:'Telefono *',le:'Email *',hi:'Via, numero civico e citta',he:'Per ricevere la conferma',f1n:'Continua',f2h:'Dati macchina',f2p:'Informazioni sul macchinario',f2s:'Passo 2 di 3',lma:'Marca *',lmo:'Modello',lse:'Numero seriale',lpr:'Descrivi il problema *',f2n:'Continua',f3h:'Riepilogo',f3p:'Controlla i dati prima di inviare',f3s:'Passo 3 di 3',sub:'Invia richiesta',sh:'Richiesta inviata!',sp:'La tua richiesta e stata ricevuta. Un tecnico Rotondi Group ti contatterà a breve.',pl:'Numero protocollo',dh:'Servizio non accettato',dp:'Ha scelto di non procedere. Puo tornare in qualsiasi momento.',rn:'Nome',ri:'Indirizzo',rt:'Telefono',re:'Email',rma:'Marca',rmo:'Modello',rse:'Seriale',rpr:'Problema'},
  en:{
    'gdpr-badge':'Privacy & GDPR',
    'gdpr-h':'Personal data processing notice',
    'gdpr-1':'Pursuant to Arts. 13-14 EU Reg. 2016/679 (GDPR), your personal data (name, address, phone, email, photos) will be processed by <b>Rotondi Group Srl</b>, Via F.lli Rosselli 14/16, 20019 Settimo Milanese (MI), as Data Controller.',
    'gdpr-2':'<b>Purpose:</b> Managing the technical assistance request and contacting the assigned technician.',
    'gdpr-3':'<b>Legal basis:</b> Performance of a contract (Art. 6(1)(b) GDPR).',
    'gdpr-4':'<b>Retention:</b> No longer than 2 years from case closure.',
    'gdpr-5':'<b>Rights:</b> Access, rectification, erasure, objection, portability. Contact: <u>segnalazioni-privacy@rotondigroup.it</u>',
    'chk1':'I have read the notice and <b>consent</b> to the processing of my personal data.',
    'chk2':'I confirm I have read the <b>service conditions</b> and <b>rates</b>.',
    'sub-gdpr':'Rotondi Group Roma - Privacy Notice',
    'gdpr-btn':'Continue',
    title:'TECHNICAL<br><em>ASSISTANCE</em>',sub:'Rotondi Group Roma - Read conditions before proceeding',ctitle:'Service information',z1:'ROME AREA RATES (inside GRA ring road)',z2:'ROME PROVINCE, LAZIO AND REST OF ITALY',r1l:'Call-out + 1h work',r2l:'Additional hours',r3l:'Travel km',r4l:'Travel hours',r5l:'Work hours',acc:'I Accept',dec:'Decline',bk:'Back',f1h:'Personal details',f1p:'Enter your contact information',f1s:'Step 1 of 3',ln:'Full name *',li:'Full address *',lt:'Phone *',le:'Email *',hi:'Street, number and city',he:'To receive confirmation',f1n:'Continue',f2h:'Machine details',f2p:'Information about the machine',f2s:'Step 2 of 3',lma:'Brand *',lmo:'Model',lse:'Serial number',lpr:'Describe the problem *',f2n:'Continue',f3h:'Summary',f3p:'Check your details before sending',f3s:'Step 3 of 3',sub:'Send request',sh:'Request sent!',sp:'Your request has been received. A technician will contact you shortly.',pl:'Protocol number',dh:'Service not accepted',dp:'You chose not to proceed.',rn:'Name',ri:'Address',rt:'Phone',re:'Email',rma:'Brand',rmo:'Model',rse:'Serial',rpr:'Problem'},
  bn:{
    'gdpr-badge':'গোপনীয়তা ও GDPR',
    'gdpr-h':'ব্যক্তিগত তথ্য প্রক্রিয়াকরণ নোটিশ',
    'gdpr-1':'EU বিধিমালা ২০১৬/৬৭৯ (GDPR) অনুসারে, আপনার ব্যক্তিগত তথ্য প্রক্রিয়া করবে <b>Rotondi Group Srl</b>, Via F.lli Rosselli 14/16, 20019 Settimo Milanese (MI)।',
    'gdpr-2':'<b>উদ্দেশ্য:</b> প্রযুক্তিগত সহায়তার অনুরোধ পরিচালনা।',
    'gdpr-3':'<b>আইনি ভিত্তি:</b> চুক্তি সম্পাদন (GDPR আর্ট. ৬(১)(বি))।',
    'gdpr-4':'<b>সংরক্ষণ:</b> সর্বোচ্চ ২ বছর।',
    'gdpr-5':'<b>অধিকার:</b> প্রবেশাধিকার, সংশোধন, মুছে ফেলা। যোগাযোগ: <u>segnalazioni-privacy@rotondigroup.it</u>',
    'chk1':'আমি নোটিশ পড়েছি এবং আমার ব্যক্তিগত তথ্য প্রক্রিয়াকরণে <b>সম্মতি দিচ্ছি</b>।',
    'chk2':'আমি <b>সেবার শর্তাবলী</b> ও <b>তারিফ</b> পড়েছি বলে নিশ্চিত করছি।',
    'sub-gdpr':'Rotondi Group Roma',
    'gdpr-btn':'এগিয়ে যান',
    title:'ASSISTENZA<br><em>TECNICA</em>',sub:'Rotondi Group Roma',ctitle:'Service Info',z1:'ROME AREA',z2:'OUTSIDE ROME',r1l:'Uscita+1h',r2l:'Extra ore',r3l:'Km',r4l:'Viaggio',r5l:'Lavoro',acc:'Accetto',dec:'Rifiuto',bk:'Back',f1h:'Personal',f1p:'Contact info',f1s:'Step 1/3',ln:'Name *',li:'Address *',lt:'Phone *',le:'Email *',hi:'Street city',he:'Confirmation',f1n:'Next',f2h:'Machine',f2p:'Machine info',f2s:'Step 2/3',lma:'Brand *',lmo:'Model',lse:'Serial',lpr:'Problem *',f2n:'Next',f3h:'Summary',f3p:'Check before send',f3s:'Step 3/3',sub:'Send',sh:'Sent!',sp:'Request received.',pl:'Protocol',dh:'Not accepted',dp:'You declined.',rn:'Name',ri:'Address',rt:'Phone',re:'Email',rma:'Brand',rmo:'Model',rse:'Serial',rpr:'Problem'},
  zh:{
    'gdpr-badge':'隐私与GDPR',
    'gdpr-h':'个人数据处理通知',
    'gdpr-1':'根据欧盟法规2016/679（GDPR），您的个人数据将由<b>Rotondi Group Srl</b>，Via F.lli Rosselli 14/16，20019 Settimo Milanese (MI)处理。',
    'gdpr-2':'<b>目的：</b>管理技术援助请求。',
    'gdpr-3':'<b>法律依据：</b>合同履行（GDPR第6(1)(b)条）。',
    'gdpr-4':'<b>保留期限：</b>不超过2年。',
    'gdpr-5':'<b>权利：</b>访问、更正、删除。联系：<u>segnalazioni-privacy@rotondigroup.it</u>',
    'chk1':'我已阅读通知并<b>同意</b>处理我的个人数据。',
    'chk2':'我确认已阅读<b>服务条款</b>和<b>收费标准</b>。',
    'sub-gdpr':'Rotondi Group Roma',
    'gdpr-btn':'继续',
    title:'技术<br><em>援助</em>',sub:'罗通迪集团罗马',ctitle:'服务信息',z1:'罗马市区收费标准',z2:'罗马省及意大利其他地区',r1l:'上门+1小时',r2l:'额外每小时',r3l:'差旅公里',r4l:'路途时间',r5l:'工作时间',acc:'我接受',dec:'拒绝',bk:'返回',f1h:'个人信息',f1p:'输入联系信息',f1s:'第1步共3步',ln:'姓名 *',li:'地址 *',lt:'电话 *',le:'邮件 *',hi:'街道门牌城市',he:'用于接收确认',f1n:'继续',f2h:'机器信息',f2p:'关于机器',f2s:'第2步共3步',lma:'品牌 *',lmo:'型号',lse:'序列号',lpr:'描述问题 *',f2n:'继续',f3h:'摘要',f3p:'发送前检查',f3s:'第3步共3步',sub:'发送',sh:'已发送！',sp:'请求已收到。',pl:'协议编号',dh:'未接受服务',dp:'您选择不继续。',rn:'姓名',ri:'地址',rt:'电话',re:'邮件',rma:'品牌',rmo:'型号',rse:'序列号',rpr:'问题'},
  ar:{
    'gdpr-badge':'الخصوصية و GDPR',
    'gdpr-h':'إشعار معالجة البيانات الشخصية',
    'gdpr-1':'وفقاً للمواد 13-14 من لائحة الاتحاد الأوروبي 2016/679 (GDPR)، ستُعالج بياناتك الشخصية من قِبَل <b>Rotondi Group Srl</b>، Via F.lli Rosselli 14/16، 20019 Settimo Milanese (MI).',
    'gdpr-2':'<b>الغرض:</b> إدارة طلب المساعدة التقنية.',
    'gdpr-3':'<b>الأساس القانوني:</b> تنفيذ عقد (المادة 6(1)(ب) من GDPR).',
    'gdpr-4':'<b>الاحتفاظ:</b> لا يتجاوز سنتين.',
    'gdpr-5':'<b>الحقوق:</b> الوصول، التصحيح، الحذف. التواصل: <u>segnalazioni-privacy@rotondigroup.it</u>',
    'chk1':'لقد قرأت الإشعار وأُوافق على <b>معالجة بياناتي الشخصية</b>.',
    'chk2':'أؤكد أنني اطلعت على <b>شروط الخدمة</b> و<b>التعريفات</b>.',
    'sub-gdpr':'Rotondi Group Roma',
    'gdpr-btn':'متابعة',
    title:'المساعدة<br><em>التقنية</em>',sub:'روتوندي جروب روما',ctitle:'معلومات الخدمة',z1:'تعريفات منطقة روما',z2:'محافظة روما ولاتسيو وبقية ايطاليا',r1l:'زيارة+ساعة',r2l:'ساعات اضافية',r3l:'كيلومترات',r4l:'ساعات السفر',r5l:'ساعات العمل',acc:'اقبل',dec:'ارفض',bk:'رجوع',f1h:'البيانات الشخصية',f1p:'ادخل معلومات الاتصال',f1s:'الخطوة 1 من 3',ln:'الاسم *',li:'العنوان *',lt:'الهاتف *',le:'البريد *',hi:'الشارع والمدينة',he:'لاستلام التاكيد',f1n:'متابعة',f2h:'بيانات الجهاز',f2p:'معلومات الجهاز',f2s:'الخطوة 2 من 3',lma:'الماركة *',lmo:'الموديل',lse:'الرقم التسلسلي',lpr:'صف المشكلة *',f2n:'متابعة',f3h:'الملخص',f3p:'تحقق قبل الارسال',f3s:'الخطوة 3 من 3',sub:'ارسال',sh:'تم الارسال!',sp:'تم استلام طلبك.',pl:'رقم البروتوكول',dh:'لم تقبل الخدمة',dp:'اخترت عدم المتابعة.',rn:'الاسم',ri:'العنوان',rt:'الهاتف',re:'البريد',rma:'الماركة',rmo:'الموديل',rse:'التسلسلي',rpr:'المشكلة'}
};
...
function chkGdpr(){
  var ok=document.getElementById('chk1').checked&&document.getElementById('chk2').checked;
  document.getElementById('btn-gdpr').disabled=!ok;
}

function loadGdprTexts(){
  var t=TX[lang];
  var ids=['gdpr-badge','gdpr-h','gdpr-1','gdpr-2','gdpr-3','gdpr-4','gdpr-5','chk1','chk2','gdpr-btn','sub-gdpr'];
...
function go(n){
  var curId=cur===-1?'s-1':('s'+cur);
  document.getElementById(curId).classList.remove('on');
  var newId=n===-1?'s-1':('s'+n);
  document.getElementById(newId).classList.add('on');cur=n;
...
function calcPrev(ind){
  ...
  .then(function(d){
    ...
    if(d.ok&&d.preventivo&&d.preventivo.zona&&d.preventivo.zona.indexOf('GRA')===-1){
...
function restart(){
  ...
  document.getElementById('btn-gdpr').disabled=true;
  go(-1);
}
